...
.body {
  ...
  background: url(@/assets/chartImage/bg.jpg) no-repeat top center;
  line-height: 1.15;
}
header {
  position: relative;
  ...
  background: url(@/assets/chartImage/head_bg.png) no-repeat;
...
.mainbox .panel {
  ...
  background: url(@/assets/chartImage/line.png) rgba(255, 255, 255, 0.03);
}
...
.map .map1 {
  ...
  background: url(@/assets/chartImage/map.png);
  background-size: 100% 100%;
  opacity: 0.3;
}
.map .map2 {
  ...
  background: url(@/assets/chartImage/lbx.png);
...
.map .map3 {
  ...
  background: url(@/assets/chartImage/jt.png);
