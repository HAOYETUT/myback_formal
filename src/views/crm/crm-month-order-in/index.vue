  ...
  <table-layout>
    <template #header>
      <simple-search :search-columns="searchColumns" @query-search="querySearch">
        ...
        <!-- <search-item><el-button type="primary" :loading="exportLoading" @click="exportOrderIn()">导出</el-button></search-item> -->
      </simple-search>
    </template>
    <vxe-table
      ref="xTable"
...
// import { monthOrderIn, getPutBoxMsg } from '@/api/box'
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      // const { data } = await monthOrderIn(requestdata).finally(() => { this.listLoading = false })
      this.tableData =  []
    },
    // 统计合计
